...
import (
	...
	github_com_gogo_protobuf_proto "github.com/temporalio/gogo-protobuf/proto"
	proto "github.com/temporalio/gogo-protobuf/proto"
	github_com_gogo_protobuf_protoc_gen_gogo_descriptor "github.com/temporalio/gogo-protobuf/protoc-gen-gogo/descriptor"
	io "io"
	io_ioutil "io/ioutil"
	math "math"
	math_bits "math/bits"
...
func OneDescription() (desc *github_com_gogo_protobuf_protoc_gen_gogo_descriptor.FileDescriptorSet) {
	...
	var gzipped = []byte{
		// 4121 bytes of a gzipped FileDescriptorSet
		...
		,
		...
		,
		...
		0xa2, 0x94, 0x7a, 0x1e, 0xc6, 0x7d, 0x97, 0x14, 0x47, 0x35, 0x5b, 0x3c, 0x37, 0x17, 0xa3, 0x3c,
		...
		,
		...
		0x8d, 0xda, 0xc8, 0x53, 0x1b, 0xaa, 0xa7, 0x86, 0xac, 0x3f, 0x41, 0xac, 0x71, 0xdc, 0xb7, 0x99,
		...
		,
		...
		,
		...
		,
		...
		,
		...
		,
	}
