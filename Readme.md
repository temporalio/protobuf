...
[![GoDoc](https://godoc.org/github.com/temporalio/gogo-protobuf?status.svg)](http://godoc.org/github.com/temporalio/gogo-protobuf)
...
<a href="https://github.com/temporalio/gogo-protobuf/issues/191">issue</a>

## Release v1.3.0

The project has updated to release v1.3.0. Check out the release notes <a href="https://github.com/temporalio/gogo-protobuf/releases/tag/v1.3.0">here</a>.
...
Install the protoc-gen-gofast binary
    ...
    go get github.com/temporalio/gogo-protobuf/protoc-gen-gofast

Use it to generate faster marshaling and unmarshaling go code for your protocol buffers.

    protoc --gofast_out=. myproto.proto

This does not allow you to use any of the other gogoprotobuf [extensions](https://github.com/temporalio/gogo-protobuf/blob/master/extensions.md).
...
Installing any of these binaries is easy.  Simply run:
    ...
    go get github.com/temporalio/gogo-protobuf/proto
    go get github.com/temporalio/gogo-protobuf/{binary}
    go get github.com/temporalio/gogo-protobuf/gogoproto

These binaries allow you to use gogoprotobuf [extensions](https://github.com/temporalio/gogo-protobuf/blob/master/extensions.md). You can also use your own binary.

To generate the code, you also need to set the include path properly.

    protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/temporalio/gogo-protobuf/protobuf --{binary}_out=. myproto.proto

To use proto files from "google/protobuf" you need to add additional args to protoc.

    protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/temporalio/gogo-protobuf/protobuf --{binary}_out=\
    Mgoogle/protobuf/any.proto=github.com/temporalio/gogo-protobuf/types,\
    Mgoogle/protobuf/duration.proto=github.com/temporalio/gogo-protobuf/types,\
    Mgoogle/protobuf/struct.proto=github.com/temporalio/gogo-protobuf/types,\
    Mgoogle/protobuf/timestamp.proto=github.com/temporalio/gogo-protobuf/types,\
    Mgoogle/protobuf/wrappers.proto=github.com/temporalio/gogo-protobuf/types:. \
    myproto.proto
...
Please visit the [extensions](https://github.com/temporalio/gogo-protobuf/blob/master/extensions.md) page for more documentation.

Install protoc-gen-gogo:

    go get github.com/temporalio/gogo-protobuf/proto
    go get github.com/temporalio/gogo-protobuf/jsonpb
    go get github.com/temporalio/gogo-protobuf/protoc-gen-gogo
    go get github.com/temporalio/gogo-protobuf/gogoproto
